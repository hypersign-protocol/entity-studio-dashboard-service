...
export class DBService {
  ...
  private getModelFields(type: SchemaType): Array<string> {
    ...
    switch (type) {
      ...
      case SchemaType.Application:
        ...
        break;
      case SchemaType.VerifiableCredential:
        keysOfModel = FieldMap.VerifiableCredential;
        break;
    }
    return keysOfModel;
  }
  ...
  update(type: SchemaType, params: object, clause: object): Promise<any> {
    return new Promise((resolve, reject) => {
