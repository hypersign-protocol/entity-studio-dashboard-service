  ...
  <div class="home">
    ...
    <div class="row">
      <div class="col-lg-3" v-for="eachOrg in orgList" :key="eachOrg._id">
        <b-card :title="eachOrg.name" :img-src="eachOrg.logo" img-alt="Image" img-top img-height="150" tag="article"
          style="max-width: 20rem; margin-top: 20px" class="mb-2 eventCard">
          <ul style="
